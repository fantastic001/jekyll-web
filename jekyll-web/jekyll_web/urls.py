...
urlpatterns = [
    ...
    url(r"^import/sources/(?P<source>[^/]+)/suggestions/$", views.article_import_suggestions, name="article-import-suggestions"),
    url(r"^import/slugs/(?P<slug>[^/]+)$", views.article_import, name="article-import"),
    url(r"^import/sources/$", views.source_list, name="source-list"),
